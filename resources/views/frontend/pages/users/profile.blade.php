...
<div class="card-body">
            <form method="POST" action="{{ route('user.profile.update') }}">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <textarea id="shipping_address" type="text" class="form-control{{ $errors->has('shipping_address') ? ' is-invalid' : '' }}" rows="4" name="shipping_address">{{ $user->shipping_address }}</textarea>
